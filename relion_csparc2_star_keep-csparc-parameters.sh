...
if [ -z $3 ] ; then
 ...
 echo '(3) start of common _rlnImageName string (e.g. 18Sep10)'
 echo
 echo 'exiting now...'
 echo
 exit
...
then
 ...
 echo ''
 echo "$PARTIN particles from $CSPARC have been searched for in $RELION and $PARTOUT have been found and written to particles_from_csparc2_WRONG.star with all parameters from $CSPARC maintained and missing field from $RELION added. As stated above, this star file is WRONG."
 echo '######################################'
 echo ''
else
 echo ''
